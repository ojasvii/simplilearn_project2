$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/features/Test1_Login_Project.feature");
formatter.feature({
...
formatter.step({
  "name": "I enter the username as \"standard_user\" and Password as \"Abc@12344\"",
  "keyword": "When "
});
formatter.match({
...
formatter.uri("file:src/test/java/features/Test2_Homepage.feature");
formatter.feature({
...
formatter.match({
  "location": "stepdefs.LoginStepDef.i_click_add_to_cart_on_product_something(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "Basket item should be increased",
  "keyword": "Then "
});
formatter.match({
  "location": "stepdefs.LoginStepDef.basket_item_should_be_increased()"
});
formatter.result({
  "status": "passed"
});
